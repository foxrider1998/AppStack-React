...
}`})]}),_=()=>t("div",{className:"mb-5",children:[e("h4",{children:"2. Add slice to root reducer"}),t("p",{className:"text-lg",children:["Open the ",e("code",{children:"/src/redux/store.ts"})," file and add the new slice:"]}),e(n,{children:`import productsReducer from "./slices/products";

export const store = configureStore({
  reducer: {
    products: productsReducer,
  },
});`})]}),P=()=>t("div",{className:"mb-5",children:[e("h4",{children:"3. Using the slice"}),e(n,{children:`import { useDispatch, useSelector } from 'react-redux';
